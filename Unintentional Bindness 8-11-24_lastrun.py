...
expName = 'Unintentional Bindness 8-11-24'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\vidna\\OneDrive\\Documents\\8-11-24 Intentional Binding\\Unintentional Bindness 8-11-24_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and beep of sound (0-999); \nClick Submit after entering the value.',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=34.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('IB-cond.csv'),
    ...
    # completed 34.0 repeats of 'trials'
